...
public class FM2Version2Obj2Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamP2");
        state2 = GameObject.Find("2GTschnellP2");
        state3 = GameObject.Find("2TiefatempoP2");
        state4 = GameObject.Find("2TieflangsamP2");
        state5 = GameObject.Find("2TiefschnellP2");
        state6 = GameObject.Find("2HochatempoP2");
        state7 = GameObject.Find("2HochlangsamP2");
        state8 = GameObject.Find("2HochschnellP2");
