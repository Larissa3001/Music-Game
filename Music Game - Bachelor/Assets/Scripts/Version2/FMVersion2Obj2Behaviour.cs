...
public class FMVersion2Obj2Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("GTlangsamP2");
        state2 = GameObject.Find("GTschnellP2");
        state3 = GameObject.Find("TiefatempoP2");
        state4 = GameObject.Find("TieflangsamP2");
        state5 = GameObject.Find("TiefschnellP2");
        state6 = GameObject.Find("HochatempoP2");
        state7 = GameObject.Find("HochlangsamP2");
        state8 = GameObject.Find("HochschnellP2");
