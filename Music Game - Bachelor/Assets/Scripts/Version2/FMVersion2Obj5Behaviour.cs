...
public class FMVersion2Obj5Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state2 = GameObject.Find("GTschnellP5");
        state3 = GameObject.Find("TiefatempoP5");
        state4 = GameObject.Find("TieflangsamP5");
        state5 = GameObject.Find("TiefschnellP5");
        state6 = GameObject.Find("HochatempoP5");
        state7 = GameObject.Find("HochlangsamP5");
        state8 = GameObject.Find("HochschnellP5");
