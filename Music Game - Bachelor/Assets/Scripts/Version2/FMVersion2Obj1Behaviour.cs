...
public class FMVersion2Obj1Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("GTlangsamP1");
        state2 = GameObject.Find("GTschnellP1");
        state3 = GameObject.Find("TiefatempoP1");
        state4 = GameObject.Find("TieflangsamP1");
        state5 = GameObject.Find("TiefschnellP1");
        state6 = GameObject.Find("HochatempoP1");
        state7 = GameObject.Find("HochlangsamP1");
        state8 = GameObject.Find("HochschnellP1");
