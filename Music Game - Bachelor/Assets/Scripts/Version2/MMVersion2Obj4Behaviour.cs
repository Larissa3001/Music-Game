...
public class MMVersion2Obj4Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("GTschnellP4");
        state2 = GameObject.Find("HochatempoP4");
        state3 = GameObject.Find("HochschnellP4");
