...
public class FM2Version2Obj1Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamP1");
        state2 = GameObject.Find("2GTschnellP1");
        state3 = GameObject.Find("2TiefatempoP1");
        state4 = GameObject.Find("2TieflangsamP1");
        state5 = GameObject.Find("2TiefschnellP1");
        state6 = GameObject.Find("2HochatempoP1");
        state7 = GameObject.Find("2HochlangsamP1");
        state8 = GameObject.Find("2HochschnellP1");
