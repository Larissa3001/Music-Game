...
public class FM2Version2Obj4Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamP4");
        state2 = GameObject.Find("2GTschnellP4");
        state3 = GameObject.Find("2TiefatempoP4");
        state4 = GameObject.Find("2TieflangsamP4");
        state5 = GameObject.Find("2TiefschnellP4");
        state6 = GameObject.Find("2HochatempoP4");
        state7 = GameObject.Find("2HochlangsamP4");
        state8 = GameObject.Find("2HochschnellP4");
