...
public class FM2Version2Obj5Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamP5");
        state2 = GameObject.Find("2GTschnellP5");
        state3 = GameObject.Find("2TiefatempoP5");
        state4 = GameObject.Find("2TieflangsamP5");
        state5 = GameObject.Find("2TiefschnellP5");
        state6 = GameObject.Find("2HochatempoP5");
        state7 = GameObject.Find("2HochlangsamP5");
        state8 = GameObject.Find("2HochschnellP5");
