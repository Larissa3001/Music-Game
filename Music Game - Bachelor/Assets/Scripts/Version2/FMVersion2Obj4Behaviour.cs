...
public class FMVersion2Obj4Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("GTlangsamP4");
        state2 = GameObject.Find("GTschnellP4");
        state3 = GameObject.Find("TiefatempoP4");
        state4 = GameObject.Find("TieflangsamP4");
        state5 = GameObject.Find("TiefschnellP4");
        state6 = GameObject.Find("HochatempoP4");
        state7 = GameObject.Find("HochlangsamP4");
        state8 = GameObject.Find("HochschnellP4");
