...
public class FM2Version2Obj3Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamP3");
        state2 = GameObject.Find("2GTschnellP3");
        state3 = GameObject.Find("2TiefatempoP3");
        state4 = GameObject.Find("2TieflangsamP3");
        state5 = GameObject.Find("2TiefschnellP3");
        state6 = GameObject.Find("2HochatempoP3");
        state7 = GameObject.Find("2HochlangsamP3");
        state8 = GameObject.Find("2HochschnellP3");
