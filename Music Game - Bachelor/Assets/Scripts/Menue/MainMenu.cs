...
public class MainMenu : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(new Rect((Screen.width / 2) - 75, Screen.height / 2 - 100, 150, 25), "Choose Mode"))
        {
            Application.LoadLevel("ModeMenu");
        }

        if (GUI.Button(new Rect((Screen.width / 2) - 75, Screen.height / 2 - 65, 150, 25), "Quit Game"))
        {
            Application.Quit();
        }
