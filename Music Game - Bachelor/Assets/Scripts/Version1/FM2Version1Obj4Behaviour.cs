...
public class FM2Version1Obj4Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamJ4");
        state2 = GameObject.Find("2GTschnellJ4");
        state3 = GameObject.Find("2TiefatempoJ4");
        state4 = GameObject.Find("2TieflangsamJ4");
        state5 = GameObject.Find("2TiefschnellJ4");
        state6 = GameObject.Find("2HochatempoJ4");
        state7 = GameObject.Find("2HochlangsamJ4");
        state8 = GameObject.Find("2HochschnellJ4");
    ...
    void Update()
    {
        ...
        clicks = GlobalValues.clicksObj4;
