...
public class FMVersion1Obj5Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state2 = GameObject.Find("GTschnellJ5");
        state3 = GameObject.Find("TiefatempoJ5");
        state4 = GameObject.Find("TieflangsamJ5");
        state5 = GameObject.Find("TiefschnellJ5");
        state6 = GameObject.Find("HochatempoJ5");
        state7 = GameObject.Find("HochlangsamJ5");
        state8 = GameObject.Find("HochschnellJ5");
