...
public class FMVersion1Obj1Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state3 = GameObject.Find("TiefatempoJ1");
        state4 = GameObject.Find("TieflangsamJ1");
        state5 = GameObject.Find("TiefschnellJ1");
        state6 = GameObject.Find("HochatempoJ1");
        state7 = GameObject.Find("HochlangsamJ1");
        state8 = GameObject.Find("HochschnellJ1");
