...
public class FM2Version1Obj2Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamJ2");
        state2 = GameObject.Find("2GTschnellJ2");
        state3 = GameObject.Find("2TiefatempoJ2");
        state4 = GameObject.Find("2TieflangsamJ2");
        state5 = GameObject.Find("2TiefschnellJ2");
        state6 = GameObject.Find("2HochatempoJ2");
        state7 = GameObject.Find("2HochlangsamJ2");
        state8 = GameObject.Find("2HochschnellJ2");
