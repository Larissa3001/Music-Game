...
public class FMVersion1Obj2Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("GTlangsamJ2");
        state2 = GameObject.Find("GTschnellJ2");
        state3 = GameObject.Find("TiefatempoJ2");
        state4 = GameObject.Find("TieflangsamJ2");
        state5 = GameObject.Find("TiefschnellJ2");
        state6 = GameObject.Find("HochatempoJ2");
        state7 = GameObject.Find("HochlangsamJ2");
        state8 = GameObject.Find("HochschnellJ2");
