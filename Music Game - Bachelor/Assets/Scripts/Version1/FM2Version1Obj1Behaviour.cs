...
public class FM2Version1Obj1Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamJ1");
        state2 = GameObject.Find("2GTschnellJ1");
        state3 = GameObject.Find("2TiefatempoJ1");
        state4 = GameObject.Find("2TieflangsamJ1");
        state5 = GameObject.Find("2TiefschnellJ1");
        state6 = GameObject.Find("2HochatempoJ1");
        state7 = GameObject.Find("2HochlangsamJ1");
        state8 = GameObject.Find("2HochschnellJ1");
