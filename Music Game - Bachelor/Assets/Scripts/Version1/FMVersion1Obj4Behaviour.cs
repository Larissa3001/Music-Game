...
public class FMVersion1Obj4Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("GTlangsamJ4");
        state2 = GameObject.Find("GTschnellJ4");
        state3 = GameObject.Find("TiefatempoJ4");
        state4 = GameObject.Find("TieflangsamJ4");
        state5 = GameObject.Find("TiefschnellJ4");
        state6 = GameObject.Find("HochatempoJ4");
        state7 = GameObject.Find("HochlangsamJ4");
        state8 = GameObject.Find("HochschnellJ4");
