...
public class FMVersion1Obj3Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state2 = GameObject.Find("GTschnellJ3");
        state3 = GameObject.Find("TiefatempoJ3");
        state4 = GameObject.Find("TieflangsamJ3");
        state5 = GameObject.Find("TiefschnellJ3");
        state6 = GameObject.Find("HochatempoJ3");
        state7 = GameObject.Find("HochlangsamJ3");
        state8 = GameObject.Find("HochschnellJ3");
