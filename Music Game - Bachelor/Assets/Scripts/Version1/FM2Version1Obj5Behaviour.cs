...
public class FM2Version1Obj5Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("2GTlangsamJ5");
        state2 = GameObject.Find("2GTschnellJ5");
        state3 = GameObject.Find("2TiefatempoJ5");
        state4 = GameObject.Find("2TieflangsamJ5");
        state5 = GameObject.Find("2TiefschnellJ5");
        state6 = GameObject.Find("2HochatempoJ5");
        state7 = GameObject.Find("2HochlangsamJ5");
        state8 = GameObject.Find("2HochschnellJ5");
