...
public class MMVersion1Obj4Behaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state1 = GameObject.Find("GTschnellJ4");
        state2 = GameObject.Find("HochatempoJ4");
        state3 = GameObject.Find("HochschnellJ4");
